	   ...
	   <div class="span12">
          ...
          <div class="widget ">
					...
					<div class="widget-content">
						<div class="container">
						<form action="{{route('manager/store-announcement')}}" method="POST" enctype="multipart/form-data">
							{{ csrf_field() }}
        ...
        <tbody>
           @foreach($an as $a)
            <tr>
                ...
                <td>
                <a href="{{route('manager/edit-announcement',$a->id)}}" class="btn btn-small btn-success" style="margin-bottom: 4px;"><i class="icon-pencil"></i></a>
                <a href="{{route('manager/delete-announcement',$a->id)}}" class="btn btn-small btn-danger"><i class="icon-remove"></i></a>
