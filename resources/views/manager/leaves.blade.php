	   ...
	   <div class="span12">
          ...
          <div class="widget ">
					...
					<div class="widget-content">
						<div class="container">
						<form action="{{route('manager/store-leaves')}}" method="POST">
							{{ csrf_field() }}
        	...
        	@foreach($leaves as $ls)
             <tr>
				...
				<ul class="dropdown-menu" style="min-width: 30px;">
					@if($ls->status == 'false')
	                  <li ><a href="{{route('manager/accept-leaves',$ls->id)}}"><i class="icon-ok-sign"></i> Accept</a></li>
	                @else
                       <li ><a href="{{route('manager/pending-leaves',$ls->id)}}"><i class="icon-remove-sign"></i> Pending</a></li>
	                @endif
				
				<li ><a href="{{route('manager/edit-leaves',$ls->id)}}"><i class="icon-pencil"></i> Edit</a></li>
				<li ><a href="{{route('manager/delete-leaves',$ls->id)}}"><i class="icon-trash"></i> Delete</a></li>
