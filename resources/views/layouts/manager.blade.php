...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li class="active"><a href="{{route('manager/dashboard')}}"><i class="icon-dashboard"></i><span>Dashboard</span> </a> </li>
        ...
        <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user"></i><span>Employee</span> <b class="caret"></b></a>
            <ul class="dropdown-menu">
              <li><a href="{{route('manager/employee-list')}}">Employee List</a></li>
              
              <li><a href="{{route('manager/add-attendances')}}">Attendances</a></li>
             
              <li><a href="{{route('manager/add-absences')}}">Absences</a></li>
        ...
        <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-gift"></i><span>Rewards</span> <b class="caret"></b></a>
            <ul class="dropdown-menu">
              <li><a href="{{route('manager/rewards')}}">New Reward</a></li>
              <li><a href="{{route('manager/calendar')}}">Calendar</a></li>
         ...
         <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-credit-card"></i><span>Payroll</span> <b class="caret"></b></a>
            <ul class="dropdown-menu">
              ...
              <li><a href="{{route('manager/salary-structure')}}">Salary Structure</a></li>
              <li><a href="{{route('manager/performance-bonus')}}">Performance Bonus</a></li>
            </ul>
          </li>
        <li>          
          <a href="{{route('manager/leaves')}}">
          ...
          <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-bullhorn"></i><span>Announcement</span> <b class="caret"></b></a>
            <ul class="dropdown-menu">
              <li><a href="{{route('manager/announcement')}}">New Announcement</a></li>
            </ul>
          </li>
